...
const zhCN: Record<string, string> = {
  ...
  'Summary': '摘要',
  'No structured findings yet': '暂时没有结构化发现',
  'The latest review only returned summary text.': '最近一次审查仅返回了摘要文本。',
  'Run review to populate this pane.': '运行审查后会填充此面板。',
  'Findings': '发现',
  'Added': '新增',
  'Deleted': '删除',
  'Renamed': '重命名',
  ...
  'Hide all': '隐藏全部',
  'No types yet': '还没有类型',
  'Browse and discover skills from the OpenClaw community': '浏览并发现来自 OpenClaw 社区的技能',
